...
| [Анализ эффективности работы операторов колл-центра](fitness_customers_outflow_analysis) |Анализ баз, проработка возможных вариантов оценки эффективности операторов| *pandas*, *seaborn*, *sklearn*, *matplotlib*, *scipy* |
