...
| [Задачи на запросы SQL](AB_test_results_analysis) |Выполнение тестовых задач в рамках выпускного проекта| *pandas*, *seaborn*, *numpy*, *matplotlib*, *datetime*, *scipy*, *plotly*  |
